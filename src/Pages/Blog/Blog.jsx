    ...
    <div>
      ...
      <div className="divide-y divide-gray-100 rounded-xl border border-gray-100 bg-white mt-20">
        ...
        >
          ...
          <p className="mt-4 leading-relaxed text-gray-700">
            <span className="font-bold">Refresh Tokens</span> are credentials
            used to obtain access tokens. Refresh tokens are issued to the
            client by the authorization server and are used to obtain a new
            access token when the current access token becomes invalid or
        ...
        <details className="group p-6 [&_summary::-webkit-details-marker]:hidden">
          ...
          <p className="mt-4 leading-relaxed text-gray-700">
            ...
            is the most common and popular programming language for the
            relational database management system. It is a language designed to
            extract, store, insert, delete, update and manage data for
            structured data and strategic analysis. SQL is widely used by top
            tech companies like Facebook, Whatsapp, etc for data processing
            solutions. It is used for different types of RDBMS including Oracle,
            MySQL, SQLServer, etc
          </p>
          <p className="mt-4 leading-relaxed text-gray-700">
            <span className="font-bold">NoSQL</span> NoSQL database provides a
            mechanism for the storage and retrieval of data that is modelled
            other than in tabular form. It was introduced by Carl Stroz in the
            year 1998 called a Non-relational database. Now, it stands for Not
            only SQL. It is not limited to storing data in tables, instead,
            enables the big data to be stored in the structured, unstructured,
        ...
        <details className="group p-6 [&_summary::-webkit-details-marker]:hidden">
          ...
          <p className="mt-4 leading-relaxed text-gray-700">
            ...
            of “convention over configuration”. It guides developers to code in
            a certain way and to use tools in a certain way. It is expected of
            ...
            able to jump into different projects because , unlike, Express —
            Nest builds follow similar conventions
          </p>
        </details>
        <details className="group p-6 [&_summary::-webkit-details-marker]:hidden">
          <summary className="flex cursor-pointer items-center justify-between gap-1.5 text-gray-900">
